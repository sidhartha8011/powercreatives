...
const inputVariants = cva(
  // Plain text-sm, NOT shadcn's `text-base md:text-sm`: the responsive variant
  // survives tailwind-merge (separate md: group) and — being emitted after base
  // utilities — beats every consumer size override at desktop width. Desktop
  // rendering is identical (14px); mobile drops 16→14px (iOS focus-zoom guard
  // traded away — this is a wp-admin tool).

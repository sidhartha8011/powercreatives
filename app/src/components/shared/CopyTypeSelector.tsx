/**
 * COPY TYPE SELECTOR — Shared Component
 *
...
/** Default available copy types */
const DEFAULT_TYPES = ['social_ads', 'social_organic'];

interface Props {
  /** Current selection state — keys are type IDs, values are booleans */
  selection: Record<string, boolean>;
  /** Callback when selection changes */
  onChange: (selection: Record<string, boolean>) => void;
  /** Optional override for available types (defaults to social_ads + social_organic) */
  types?: string[];
  /** Optional override for labels */

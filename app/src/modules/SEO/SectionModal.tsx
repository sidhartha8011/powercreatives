...
// THE DECOMPOSITION (S1, gap 325d280): the editor's laws, extensions,
// scales, and contracts live in editor/ — the component only composes.
import {
  DiffAdded, DiffRemoved, FaqItem, FaqSummary, LockedImage, ReviewControls, SectionBlocks,
} from './editor/extensions';
import {
  canonicalAiHtml, composeSectionHtml, escapeHtml, faqTemplate, htmlText, normSrc,
  restateOrigin, stampReviewId, stripPcmAnchors,
} from './editor/content-laws';
import {
  BLOCK_STYLES, LANGUAGE_LAW, PAGE_TYPE_SCALE, TYPE_SCALE, WIDTH, pageCardWidth,
} from './editor/layout';
import { ToolButton } from './editor/ToolButton';
import type {
  ImgSelection, InsertData, ReviewSection, ReviewStatus, SectionAnchor, SectionData, SectionParagraph,
} from './editor/types';
...
import { type CompiledDirective, type TeacherMeta } from './optimizer/types';

...
import { PillButton, ModelDropdown, colors, typography, spacing } from '@/components/shared';
...
// ─── Model Dropdown: THE shared picker (extracted 2026-07-13, owner order —
//     one dropdown everywhere; SEO's page editor uses the same component). ───

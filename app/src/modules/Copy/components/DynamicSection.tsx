 ...
 * Fields are shown/hidden based on currently selected copy types.
 * All rendering is driven by CopySectionConfig — no hardcoded UI.
 *
...
import { isFieldVisible } from "../copyConfig";
...
interface Props {
  ...
  selectedTypes: CopyTypeSelection;
          ...
          <div className="grid grid-cols-1 gap-y-2.5">
            {visibleFields.map((field) => (
              <div key={field.id} className="col-span-1">
                ...
                >
                  {field.label}
                  {/* Show required asterisk for ads-required fields */}
                  {field.requirements?.social_ads === "required" &&
                    selectedTypes.social_ads && (

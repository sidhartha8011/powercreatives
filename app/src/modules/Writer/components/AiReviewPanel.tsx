 ...
 *
 * Its OWN right-side drawer (per the 20260715 card: "the AI thing can have
 * its own place, not in the same drawer" as Revisions — no tab toggle).
 * Hosts the per-article AI Review pipeline: the user optionally types
 * editorial feedback, runs a review, and gets structured suggestions
 * ({find, issue, replacement}) back — each individually applyable
 * (server-side surgical replace) or rejectable.
 *
 * Architecture:
...
export function AiReviewPanel({ onCollapse }: Props) {

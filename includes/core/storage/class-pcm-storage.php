...
class PCM_Storage
{
     ...
     */
    public static function upload(string $file_path, string $context = 'general', string $filename = ''): array
    {
     ...
     * @return array{id: int, url: string}
     */
    public static function save_data(string $data, string $filename, string $mime_type, string $context = 'api-response'): array
    {
        ...
        try {
            $result = self::upload($tmp, $context, $filename);
        }
        finally {
            if (file_exists($tmp)) {

...
- **Connector = `PCM_SEOHub_Service::connector_php_simple()`** (generic, no handshake), now
  **v2.4.0 (was v2.0.0 = universal builder-aware link replacement)**: pluggable handler architecture

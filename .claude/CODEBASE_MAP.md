...
- Providers: **openai, google (Veo/Gemini), fal, kieai, anthropic, ahrefs, brevo, proranktracker, gsc**
  ...
  each GSC property (the card shows the 3-step setup). **brevo** = transactional email (HTTP API, not SMTP) used by

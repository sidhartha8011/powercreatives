...
````yaml market/flux2/pro-image-to-image.json post /api/v1/jobs/createTask
openapi: 3.0.0
info:
  title: Flux-2 API
  description: kie.ai Flux-2 API Documentation
  version: 1.0.0
  contact:
...
paths:
  /api/v1/jobs/createTask:
    post:
      summary: Generate content using flux-2/pro-image-to-image
            ...
            schema:
              ...
              properties:
                model:
                  ...
                  example: flux-2/pro-image-to-image
                callBackUrl:
                  type: string
                  format: uri
                  description: >-
                ...
                input:
                  ...
                  properties:
                    ...
                    prompt:
                      ...
                      maxLength: 5000
                      example: >-
                        The jar in image 1 is filled with capsules exactly same
                        as image 2 with the exact logo
                    aspect_ratio:
                      description: >-
                      ...
                      data:
                        ...
                        properties:
                          taskId:
                            ...
                            example: task_flux-2_1765174753676
              example:
                code: 200
                msg: success
                data:

...
````yaml market/recraft/remove-background.json post /api/v1/jobs/createTask
openapi: 3.0.0
info:
  title: Recraft API
  description: kie.ai Recraft API Documentation
  version: 1.0.0
  contact:
...
paths:
  /api/v1/jobs/createTask:
    post:
      summary: Generate content using recraft/remove-background
                      ...
                      data:
                        ...
                        properties:
                          taskId:
                            ...
                            example: task_recraft_1765177006198
              example:
                code: 200
                msg: success
                data:

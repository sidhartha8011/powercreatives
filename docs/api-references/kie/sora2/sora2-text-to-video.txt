...
````yaml market/sora2/sora-2-text-to-video.json post /api/v1/jobs/createTask
openapi: 3.0.0
info:
  title: Sora-2-text-to-video API
  description: kie.ai Sora-2-text-to-video API Documentation - Text to Video
  version: 1.0.0
  contact:
...
paths:
  /api/v1/jobs/createTask:
    post:
      summary: Generate videos from text using sora-2-text-to-video
                  ...
                  properties:
                    prompt:
                      ...
                      example: >-
                        ...
                        behind him are colorful chalk diagrams. With an animated
                        gesture, he declares to the students: “Sora 2 is now
                        available on Kie AI, making it easier than ever to
                        create stunning videos.” The students listen
                      ...
                      data:
                        ...
                        properties:
                          taskId:
                            ...
                            example: task_sora-2-text-to-video_1765184035859
              example:
                code: 200
                msg: success
                data:

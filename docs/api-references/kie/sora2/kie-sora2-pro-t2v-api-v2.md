...
```json
{
  ...
  "data": {
    ...
    "model": "sora-2-pro-text-to-video",
    "state": "waiting",
    "param": "{\"model\":\"sora-2-pro-text-to-video\",\"input\":{\"prompt\":\"a happy dog running in the garden\",\"aspect_ratio\":\"landscape\",\"n_frames\":\"10\",\"size\":\"high\",\"remove_watermark\":true,\"upload_method\":\"s3\"}}",

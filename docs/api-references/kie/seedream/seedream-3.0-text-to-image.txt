...
````yaml market/seedream/seedream.json post /api/v1/jobs/createTask
openapi: 3.0.0
info:
  title: Bytedance API
  description: kie.ai Bytedance API Documentation
  version: 1.0.0
  contact:
...
paths:
  /api/v1/jobs/createTask:
    post:
      summary: Generate content using bytedance/seedream
        ...
        content:
          application/json:
                  ...
                  properties:
                    prompt:
                      ...
                      example: >-
                        ...
                        birds, green grass, and a flowing river, all illustrated
                        in clean vector art.
                    image_size:
            ...
            example:
              ...
              input:
                prompt: >-
                  A 2D flat art style campsite poster with the text “Kie AI
                  Seedream 3.0 API”. The scene includes mountains, brown tents
                  under a sunny sky, a rabbit, a deer, some birds, green grass,
                  and a flowing river, all illustrated in clean vector art.
                      ...
                      data:
                        ...
                        properties:
                          taskId:
                            ...
                            example: task_bytedance_1765177777132
              example:
                code: 200
                msg: success
                data:
